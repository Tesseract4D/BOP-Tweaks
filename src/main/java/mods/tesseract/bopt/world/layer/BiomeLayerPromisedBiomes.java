...
public class BiomeLayerPromisedBiomes extends BiomeLayerPromised {
    ...
    public BiomeLayerPromisedBiomes(long par1, BiomeLayerHell par3GenLayer) {
        ...
        this.promisedBiomes.add(new BiomeManager.BiomeEntry(BOPTBiomes.promisedLandPlains,10));
        this.promisedBiomes.add(new BiomeManager.BiomeEntry(BOPTBiomes.promisedLandShrub,10));
        this.promisedBiomes.add(new BiomeManager.BiomeEntry(BOPTBiomes.promisedLandSwamp,10));
    }
