...
import mods.tesseract.bopt.world.BiomeCachePromised;
import mods.tesseract.bopt.world.layer.BiomeLayerPromised;
...
public class WorldChunkManagerPromised extends WorldChunkManager {
    ...
    private BiomeCachePromised biomeCache = new BiomeCachePromised(this);

    protected WorldChunkManagerPromised() {}

    public WorldChunkManagerPromised(long par1, WorldType par3WorldType) {
        this();
        GenLayer[] var4 = BiomeLayerPromised.initializeAllBiomeGenerators(par1, par3WorldType);
